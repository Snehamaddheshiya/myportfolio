        ...
        {[...languages, ...frameworks, ...tools].map((skill, index) => {
          ...
          return (
            <motion.div
              ...
              className="absolute flex items-center justify-center px-4 flex-col py-3 bg-[#0c0c0c]/80 backdrop-blur-sm border rounded-full cursor-grab active:cursor-grabbing text-sm font-medium shadow-2xl group/node"
              style={{ left, top, borderColor: `${color}40`, color: '#fff' }}
            >
